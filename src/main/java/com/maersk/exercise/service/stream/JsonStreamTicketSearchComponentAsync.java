...
@Component
public class JsonStreamTicketSearchComponentAsync {

    private final JsonObjectExtractAndCollectComponent jsonObjectExtractAndCollectComponent;

    public JsonStreamTicketSearchComponentAsync(JsonObjectExtractAndCollectComponent jsonObjectExtractAndCollectComponent) {
        this.jsonObjectExtractAndCollectComponent = jsonObjectExtractAndCollectComponent;
    }

    @Async
    public Future<JsonArray> searchByUsingStream(String attribute, String value, BufferedReader bufferedReader) throws IOException {
